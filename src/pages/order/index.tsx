...
// @ts-ignore
import CreateOrderModal, { CreateOrderForm } from '../../components/orders/CreateOrderModal.tsx';
// @ts-ignore
import { createOrderAction, getOrderAction } from '../../store/orders/orders.action.ts';
// @ts-ignore
import { StoreState } from '../../models/store.ts';
// @ts-ignore
import { OrderModel } from '../../models/order.ts';
// @ts-ignore
import { useTableColumn } from '../../hooks/orders.tsx';
// @ts-ignore
    ...
    <>
      <Space size={'large'} direction={'vertical'} style={{ width: '100%' }}>
        <PageHeader
          title="Setel"
          extra={[
            <Button onClick={() => setShowCreateModal(true)} title={'Create'} key={1}>
              <PlusOutlined />
              Create New Order
            </Button>,
          ]}
        ...
        <Table
          ...
          pagination={{
            onChange: (_page, _pageSize) => setPagination({ page: _page, pageSize: _pageSize }),
